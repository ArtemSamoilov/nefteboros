...
_RUSSIAN_GAS_PATTERNS = [
    ...
    # «газ(а/у/ом) в России / в РФ»
    r"\bгаз\w{0,3}\s+в\s+(?:росси|рф)\w*\b",
    # «газ для (населения / бытовых потребителей / потребителей в РФ)» —
    # bytовая газификация, явный indicator РФ-внутреннего газа
    r"\bгаз\w{0,3}\s+для\s+(?:населен|бытов|потреб)\w*\b",
